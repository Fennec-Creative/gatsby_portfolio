        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7 col-md-10 mb-30">
              <h2 className="s-head text-center mb-30">Contextual Inquires</h2>
              <p className="mb-20">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 col-md-10 mt-30">
              <img src="/img/case-studies/research-contextual-inquires.png" alt="image" />
            </div>
          </div>
        </div>
      </section>
...
export default ContextInquiresResearch;
