        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-7 col-md-10 mb-30">
              <h2 className="s-head text-center mb-30">The Octalysis Framework</h2>
              <p className="mb-20">
              The Octalysis Framework is a design framework that combines behavioral science concepts and with game-centric design. 
              </p>
              <p className="mb-20">
